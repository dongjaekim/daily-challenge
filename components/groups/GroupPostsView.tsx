...
export function GroupPostsView({ groupId, challenges }: GroupPostsViewProps) {
  ...
  useEffect(() => {
    async function fetchPosts() {
      ...
      const challengeId =
        selectedChallenge !== "all" ? selectedChallenge : null;
      ...
      try {
        ...
        const url = `/api/groups/${groupId}/posts${
          selectedChallenge !== "all" ? `?challengeId=${selectedChallenge}` : ""
        }`;
